...
#6.
#student_names outputs student names
class(student_names)

#test_scores outputs each student's test scores
class(test_scores)

#on_scholarship outputs whether the student is on a scholarship
class(on_scholarship)
