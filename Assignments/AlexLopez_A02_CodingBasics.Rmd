...
```{r basics 1}
#1.
seq(1, 55, 5) #sequence function seq(from, to, by)

five_sequence <- seq(1, 55, 5) #name sequence function
five_sequence #call sequence function

#2. 
mean(five_sequence) #compute mean of sequence
median(five_sequence) #compute median of sequence

#3. 
mean(five_sequence) > median(five_sequence) #output will be TRUE if statement is true, FALSE if statement is false
```
